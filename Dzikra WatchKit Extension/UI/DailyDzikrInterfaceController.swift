//
//  DailyDzikrInterfaceController.swift
...
class DailyDzikrInterfaceController: WKInterfaceController {
    
    @IBOutlet weak var tableView: WKInterfaceTable!
    
    let dzikrDict = [
        ("", "Hasbiyallah", 7, "#C4DEF6"),
        ("Istighfar", "Astaghfirullah al-adzhim", 100, "#EB9694"),
        ("Sholawat", "Allahumma sholli 'ala sayydina muhammad", 100, "#C1E1C5")
    ]
